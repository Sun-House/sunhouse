    ...
    if (breadcrumb(), set(), filters(), window.innerWidth < 1200) mobile();
        ...
        $(".shelfProduct").each((function () {
            ...
            $(".shelfProduct").css("height", a + "px"), $(".shelfProduct").each((function () {
                if (0 > $(this).find(".shelfProduct__price").text().indexOf("Esgotado") && 0 > $(this).find(".shelfProduct__price-installment").text().indexOf("10x") && 0 > $(this).find(".shelfProduct__price").text().indexOf("Exclusivo Loja")) {
