...
$(document).ready((function () {
    $('<div id="backToTop">\t<span><p>VOLTAR AO</p>\t<strong>TOPO</strong></span>\t<i class="backtop-icon"></i>\t</div>').appendTo("body"), $(window).scroll((function () {
        ...
        $(".shelfProduct").each((function () {
            if (0 === $(this).find(".shelfProduct__image.hover img").length && $(this).find(".shelfProduct__image img").clone().appendTo($(this).find(".shelfProduct__image.hover")), 0 > $(this).find(".shelfProduct__price").text().indexOf("Esgotado") && 0 > $(this).find(".shelfProduct__price").text().indexOf("Exclusivo Loja") && !$(this).hasClass("pc")) {
                $(this).addClass("pc");
